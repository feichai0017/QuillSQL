...
| File | Role |
| ---- | ---- |
| `exec.rs` | DataFusion physical execution nodes for compiled filter/project and filter/sum islands. |
...
| `rule.rs` | DataFusion physical optimizer rule that rewrites supported compiled islands. |
